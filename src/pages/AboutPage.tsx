...
export function AboutPage() {
    return (
        <div className="container mx-auto max-w-2xl pb-16 px-6">
            <h1 className="header">
                <center>
                    About us
                </center>
            ...
            <div className="text">
                Quality Assurance: Every product in our inventory undergoes rigorous quality checks to ensure that you receive only the finest items. We believe in offering products that we would be proud to use ourselves.
                <br/><br/>
                Customer-Centric Approach: Your satisfaction is our priority. Our customer support team is here to assist you with any questions or concerns, making your shopping journey with us as smooth as possible.
                <br/><br/>
                Curated Selection: We understand that your time is valuable. That's why our team works tirelessly to curate a selection of products that align with the latest trends, ensuring you have access to the best choices in everything.
            </div>
            <h1 className="header">
                <center>
